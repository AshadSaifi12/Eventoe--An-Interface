...
function Home() {
  ...
  async function handleSearch(value) {
    ...
    await fetch(`/article/getArticles?value=${value}&searchBy=${searchBy}`).then(result => {
      console.log(result)
      return result.json();
    }).then(res => {
      setArticles2(res);
      ...
      <div className="container">
        ...
        <div className="sec2">
          <div className="searchDropDown">
            <label style={{ marginRight:"1vh" }} htmlFor="">Search by</label>
